    ...
    <div className="min-h-screen bg-[#0f172a] text-white flex flex-col">
      <header className="flex items-center justify-between px-6 md:px-12 py-5">
        ...
        <div className="flex items-center gap-3">
          ...
          <Link to={createPageUrl("SignIn")}><Button className="bg-amber-400 hover:bg-amber-500 text-[#0f172a] font-semibold text-sm">Sign In</Button></Link>
        </div>
      </header>
      ...
      <main className="flex-1 flex flex-col items-center justify-center text-center px-6 py-20">
        ...
        <div className="flex flex-col sm:flex-row gap-3 mt-10">
          ...
          <Link to={createPageUrl("SignIn")}><Button size="lg" variant="outline" className="border-white/20 text-white hover:bg-white/5 px-8">Admin Login</Button></Link>
        </div>
